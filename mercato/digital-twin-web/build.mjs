...
await build({ entryPoints: ['tracker.js'], bundle: true, minify: true, format: 'iife', globalName: 'PhysicalAiTracker', outfile: '../modules/digital_twins/assets/tracker.js', target: ['es2022'], legalComments: 'eof' })
